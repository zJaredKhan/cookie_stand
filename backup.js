...
Franchise.prototype.calculateCookiesSoldEachHours = function() {
  for(var i = 0; i < 15; i++){
    var cookies = Math.floor(this.calculateCustomersPerHours() * this.avgCookiesPerSale);
    this.cookiesSoldEachHour.push(cookies);
    this.cookiesSum += cookies;
  }
...
function generateTableHeading(){
  ...
  tdTotal.textContent = 'this.cookiesSum';
